 ...
 * - {@link RealTimeRoomStatusParametersCreateFragment}: to create or edit a(n) RealTimeRoomStatusParametersType,
 * - {@link RealTimeRoomStatusParametersDetailFragment}: to display the details of a(n) RealTimeRoomStatusParametersType,
 * - {@link RealTimeRoomStatusParametersListFragment}: to list RealTimeRoomStatusParameters.
 *
 ...
 * what to do.
 */
public class RealTimeRoomStatusParametersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<RealTimeRoomStatusParametersType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link RealTimeRoomStatusParametersListFragment} is
     * getting instantiated (which will load {@link RealTimeRoomStatusParametersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new RealTimeRoomStatusParametersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable RealTimeRoomStatusParametersType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        RealTimeRoomStatusParametersCreateFragment fragment = new RealTimeRoomStatusParametersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable RealTimeRoomStatusParametersType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new RealTimeRoomStatusParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new RealTimeRoomStatusParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable RealTimeRoomStatusParametersType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link RealTimeRoomStatusParametersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((RealTimeRoomStatusParametersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            RealTimeRoomStatusParametersTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(RealTimeRoomStatusParametersTypeViewModel.class);
