 ...
 * - {@link ProximityDetectedSetCreateFragment}: to create or edit a(n) ProximityDetectedSetType,
 * - {@link ProximityDetectedSetDetailFragment}: to display the details of a(n) ProximityDetectedSetType,
 * - {@link ProximityDetectedSetListFragment}: to list ProximityDetectedSet.
 *
 ...
 * what to do.
 */
public class ProximityDetectedSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ProximityDetectedSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ProximityDetectedSetListFragment} is
     * getting instantiated (which will load {@link ProximityDetectedSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProximityDetectedSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ProximityDetectedSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ProximityDetectedSetCreateFragment fragment = new ProximityDetectedSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ProximityDetectedSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProximityDetectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ProximityDetectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ProximityDetectedSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ProximityDetectedSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ProximityDetectedSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ProximityDetectedSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(ProximityDetectedSetTypeViewModel.class);
