 ...
 * - {@link DeviceUserViewSetCreateFragment}: to create or edit a(n) DeviceUserViewSetType,
 * - {@link DeviceUserViewSetDetailFragment}: to display the details of a(n) DeviceUserViewSetType,
 * - {@link DeviceUserViewSetListFragment}: to list DeviceUserViewSet.
 *
 ...
 * what to do.
 */
public class DeviceUserViewSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DeviceUserViewSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DeviceUserViewSetListFragment} is
     * getting instantiated (which will load {@link DeviceUserViewSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceUserViewSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DeviceUserViewSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DeviceUserViewSetCreateFragment fragment = new DeviceUserViewSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DeviceUserViewSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceUserViewSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DeviceUserViewSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DeviceUserViewSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DeviceUserViewSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DeviceUserViewSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DeviceUserViewSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(DeviceUserViewSetTypeViewModel.class);
