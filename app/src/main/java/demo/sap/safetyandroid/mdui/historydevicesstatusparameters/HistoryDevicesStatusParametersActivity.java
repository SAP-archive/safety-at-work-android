 ...
 * - {@link HistoryDevicesStatusParametersCreateFragment}: to create or edit a(n) HistoryDevicesStatusParametersType,
 * - {@link HistoryDevicesStatusParametersDetailFragment}: to display the details of a(n) HistoryDevicesStatusParametersType,
 * - {@link HistoryDevicesStatusParametersListFragment}: to list HistoryDevicesStatusParameters.
 *
 ...
 * what to do.
 */
public class HistoryDevicesStatusParametersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<HistoryDevicesStatusParametersType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link HistoryDevicesStatusParametersListFragment} is
     * getting instantiated (which will load {@link HistoryDevicesStatusParametersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new HistoryDevicesStatusParametersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable HistoryDevicesStatusParametersType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        HistoryDevicesStatusParametersCreateFragment fragment = new HistoryDevicesStatusParametersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable HistoryDevicesStatusParametersType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new HistoryDevicesStatusParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new HistoryDevicesStatusParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable HistoryDevicesStatusParametersType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link HistoryDevicesStatusParametersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((HistoryDevicesStatusParametersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            HistoryDevicesStatusParametersTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(HistoryDevicesStatusParametersTypeViewModel.class);
