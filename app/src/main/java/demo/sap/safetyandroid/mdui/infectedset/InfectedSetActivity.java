 ...
 * - {@link InfectedSetCreateFragment}: to create or edit a(n) InfectedSetType,
 * - {@link InfectedSetDetailFragment}: to display the details of a(n) InfectedSetType,
 * - {@link InfectedSetListFragment}: to list InfectedSet.
 *
 ...
 * what to do.
 */
public class InfectedSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<InfectedSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link InfectedSetListFragment} is
     * getting instantiated (which will load {@link InfectedSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InfectedSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable InfectedSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        InfectedSetCreateFragment fragment = new InfectedSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable InfectedSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InfectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new InfectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable InfectedSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link InfectedSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((InfectedSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            InfectedSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(InfectedSetTypeViewModel.class);
