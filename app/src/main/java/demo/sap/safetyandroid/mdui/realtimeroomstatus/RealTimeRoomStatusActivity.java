 ...
 * - {@link RealTimeRoomStatusCreateFragment}: to create or edit a(n) RealTimeRoomStatusType,
 * - {@link RealTimeRoomStatusDetailFragment}: to display the details of a(n) RealTimeRoomStatusType,
 * - {@link RealTimeRoomStatusListFragment}: to list RealTimeRoomStatus.
 *
 ...
 * what to do.
 */
public class RealTimeRoomStatusActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<RealTimeRoomStatusType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link RealTimeRoomStatusListFragment} is
     * getting instantiated (which will load {@link RealTimeRoomStatusDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new RealTimeRoomStatusListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable RealTimeRoomStatusType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        RealTimeRoomStatusCreateFragment fragment = new RealTimeRoomStatusCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable RealTimeRoomStatusType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new RealTimeRoomStatusDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new RealTimeRoomStatusDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable RealTimeRoomStatusType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link RealTimeRoomStatusCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((RealTimeRoomStatusActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            RealTimeRoomStatusTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(RealTimeRoomStatusTypeViewModel.class);
