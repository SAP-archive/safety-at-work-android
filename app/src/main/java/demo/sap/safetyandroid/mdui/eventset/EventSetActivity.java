 ...
 * - {@link EventSetCreateFragment}: to create or edit a(n) EventSetType,
 * - {@link EventSetDetailFragment}: to display the details of a(n) EventSetType,
 * - {@link EventSetListFragment}: to list EventSet.
 *
 ...
 * what to do.
 */
public class EventSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<EventSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EventSetListFragment} is
     * getting instantiated (which will load {@link EventSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EventSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable EventSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EventSetCreateFragment fragment = new EventSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable EventSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EventSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EventSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable EventSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EventSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EventSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EventSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(EventSetTypeViewModel.class);
