 ...
 * - {@link EphemeralIDSetCreateFragment}: to create or edit a(n) EphemeralIDSetType,
 * - {@link EphemeralIDSetDetailFragment}: to display the details of a(n) EphemeralIDSetType,
 * - {@link EphemeralIDSetListFragment}: to list EphemeralIDSet.
 *
 ...
 * what to do.
 */
public class EphemeralIDSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<EphemeralIDSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EphemeralIDSetListFragment} is
     * getting instantiated (which will load {@link EphemeralIDSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EphemeralIDSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable EphemeralIDSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EphemeralIDSetCreateFragment fragment = new EphemeralIDSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable EphemeralIDSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EphemeralIDSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EphemeralIDSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable EphemeralIDSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EphemeralIDSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EphemeralIDSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EphemeralIDSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(EphemeralIDSetTypeViewModel.class);
