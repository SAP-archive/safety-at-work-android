 ...
 * - {@link EphemeralIDInfectedSetCreateFragment}: to create or edit a(n) EphemeralIDInfectedSetType,
 * - {@link EphemeralIDInfectedSetDetailFragment}: to display the details of a(n) EphemeralIDInfectedSetType,
 * - {@link EphemeralIDInfectedSetListFragment}: to list EphemeralIDInfectedSet.
 *
 ...
 * what to do.
 */
public class EphemeralIDInfectedSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<EphemeralIDInfectedSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EphemeralIDInfectedSetListFragment} is
     * getting instantiated (which will load {@link EphemeralIDInfectedSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EphemeralIDInfectedSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable EphemeralIDInfectedSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EphemeralIDInfectedSetCreateFragment fragment = new EphemeralIDInfectedSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable EphemeralIDInfectedSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EphemeralIDInfectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EphemeralIDInfectedSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable EphemeralIDInfectedSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EphemeralIDInfectedSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EphemeralIDInfectedSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EphemeralIDInfectedSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(EphemeralIDInfectedSetTypeViewModel.class);
