 ...
 * - {@link DeviceSetCreateFragment}: to create or edit a(n) DeviceSetType,
 * - {@link DeviceSetDetailFragment}: to display the details of a(n) DeviceSetType,
 * - {@link DeviceSetListFragment}: to list DeviceSet.
 *
 ...
 * what to do.
 */
public class DeviceSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DeviceSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DeviceSetListFragment} is
     * getting instantiated (which will load {@link DeviceSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DeviceSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DeviceSetCreateFragment fragment = new DeviceSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DeviceSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DeviceSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DeviceSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DeviceSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DeviceSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DeviceSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(DeviceSetTypeViewModel.class);
