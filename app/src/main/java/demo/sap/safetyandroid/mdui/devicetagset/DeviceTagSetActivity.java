 ...
 * - {@link DeviceTagSetCreateFragment}: to create or edit a(n) DeviceTagSetType,
 * - {@link DeviceTagSetDetailFragment}: to display the details of a(n) DeviceTagSetType,
 * - {@link DeviceTagSetListFragment}: to list DeviceTagSet.
 *
 ...
 * what to do.
 */
public class DeviceTagSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DeviceTagSetType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DeviceTagSetListFragment} is
     * getting instantiated (which will load {@link DeviceTagSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceTagSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DeviceTagSetType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DeviceTagSetCreateFragment fragment = new DeviceTagSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DeviceTagSetType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeviceTagSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DeviceTagSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DeviceTagSetType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DeviceTagSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DeviceTagSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DeviceTagSetTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(DeviceTagSetTypeViewModel.class);
