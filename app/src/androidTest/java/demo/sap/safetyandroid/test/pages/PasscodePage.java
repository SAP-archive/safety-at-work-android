...
import demo.sap.safetyandroid.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("demo.sap.safetyandroid:id/passcode_field")).setText(passcode);
